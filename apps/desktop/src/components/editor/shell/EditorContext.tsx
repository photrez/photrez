...
export function EditorProvider(props: {
  ...
  const toolValue: ToolSettingsValue = {
    ...
    snapToLayersEnabled: editorState.snapToLayersEnabled,
    setSnapToLayersEnabled: editorState.setSnapToLayersEnabled,
    snapToCanvasEnabled: editorState.snapToCanvasEnabled,
    setSnapToCanvasEnabled: editorState.setSnapToCanvasEnabled,
    ...
    textUnderline: editorState.textUnderline,
    setTextUnderline: editorState.setTextUnderline,
    textStrikethrough: editorState.textStrikethrough,
    setTextStrikethrough: editorState.setTextStrikethrough,
    textUppercase: editorState.textUppercase,
    setTextUppercase: editorState.setTextUppercase,
    textEditSession: editorState.textEditSession,
    setTextEditSession: editorState.setTextEditSession,
